...
function cards(){
    ...
    (0,_services_servises__WEBPACK_IMPORTED_MODULE_0__.getResorce)('http://localhost:3000/menu')
    .then(data => {
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('2021-07-21', '.timer');
